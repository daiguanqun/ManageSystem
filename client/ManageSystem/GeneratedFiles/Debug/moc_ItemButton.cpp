/****************************************************************************
** Meta object code from reading C++ file 'ItemButton.h'
**
...
#error "The header file 'ItemButton.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 24, 13) // "OnItemClicked"

    },
    "ItemButton\0itemClicked\0\0OnItemClicked"
};
...
void ItemButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ItemButton *_t = static_cast<ItemButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (ItemButton::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ItemButton::itemClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ItemButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_ItemButton.data,
      qt_meta_data_ItemButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ItemButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ItemButton.stringdata0))
        return static_cast<void*>(const_cast< ItemButton*>(this));
...
// SIGNAL 0
void ItemButton::itemClicked(int _t1)
{
