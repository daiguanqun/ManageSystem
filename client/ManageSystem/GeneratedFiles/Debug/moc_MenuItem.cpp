...
QT_MOC_LITERAL(1, 9, 11), // "itemClicked"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 21) // "OnExpandButtonClicked"

    },
    "MenuItem\0itemClicked\0\0OnExpandButtonClicked"
};
...
void MenuItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->OnExpandButtonClicked(); break;
        default: ;
        }
        ...
        {
            typedef void (MenuItem::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MenuItem::itemClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MenuItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MenuItem.data,
...
// SIGNAL 0
void MenuItem::itemClicked(int _t1)
{
